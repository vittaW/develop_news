...
public abstract class ViewMainActivity<P extends BasePresenter> extends BaseActivity<P> {
    ...
    protected void initView() {
        ...
        if (viewMain == null){
            throw new IllegalStateException("继承自ViewMainActivity的子类的布局中必须包含 view 的名字是 'view_main'");
        }
