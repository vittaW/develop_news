...
public abstract class ViewMainFragment<P extends BasePresenter> extends BaseFragment<P> {
    ...
    protected void initView() {
        ...
        if (viewMain == null) {
            throw new IllegalStateException(
                    "The subclass of ViewMainFragment must contain a View named 'view_main'.");
        }
